 ...
 */
public class MyCommandFactory extends ScpCommandFactory {
        ...
        return new Command() {
            ...
            public void start(final Environment env) throws IOException {
                ...
                if (command.equals("id -G") || command.equals("id -u")) {
                    System.out.println("IDGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG");
                    new PrintStream(out).println(1111);
